            ...
            <CardContent className="p-3 md:p-4 flex flex-col md:flex-row md:items-center justify-between gap-3 md:gap-4">
              <div className="flex items-center gap-3">
                <div className={cn(
                  ...
                  isPending ? "bg-emerald-500/20 text-emerald-500" : "bg-white/10 text-white/30"
                )}>
                  <Swords size={18} />
                </div>
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="text-xs md:text-sm font-black uppercase italic tracking-tighter truncate">
